<template>
	...
	>
		...
		<li class="relative">
			...
			>
				<img
					src="https://images.unsplash.com/photo-1614926857083-7be149266cda?ixlib=rb-1.2.1&ixqx=K0fA5XS27f&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=512&q=80"
					alt=""
					class="group-hover:opacity-75 object-cover pointer-events-none"
				/>
				<button type="button" class="absolute inset-0">
		...
		<li class="relative">
			...
			>
				<img
					src="https://images.unsplash.com/photo-1497436072909-60f360e1d4b1?ixlib=rb-1.2.1&ixqx=K0fA5XS27f&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=512&q=80"
					alt=""
					class="group-hover:opacity-75 object-cover pointer-events-none"
				/>
				<button type="button" class="absolute inset-0">
